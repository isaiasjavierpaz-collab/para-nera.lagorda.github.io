...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para la mejor amiga:\n\nTe quieroo mucho gorda come hambuguersas, te adoro mucho  .\n\nGracias por acompañarme siempre, por entenderme incluso en silencio, y por llenar mis días de amor.\n\nTe quiero más de lo que las palabras pueden expresar.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con cariño, Isa";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-07-09T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-07-09T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Tiempo siendo amiguitos: <b>${days}</b> días<br>` +
      `Cumplir un años de amistad: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
